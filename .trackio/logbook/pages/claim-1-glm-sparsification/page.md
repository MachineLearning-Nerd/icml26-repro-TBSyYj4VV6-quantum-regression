...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_8bcdd2bc5472", "created_at": "2026-07-29T12:47:08+00:00", "title": "Evidence"}
-->
Theorem 10 is checked in three m-dominant parameter cells. The classical-over-quantum leading-term ratios are 2, 10, and 5.

Control: a small-m/high-n cell rejects the claimed m-dominant advantage.


---
<!-- trackio-cell
{"type": "code", "id": "cell_e0dace00d46f", "created_at": "2026-07-29T12:47:36+00:00", "title": "Six-claim verifier", "command": [".venv/bin/python", "repro/src/verify.py"], "exit_code": 0, "duration_s": 0.066}
-->
````bash
...
````output
{"all_claims_passed": true, "claims": {"C1": true, "C2": true, "C3": true, "C4": true, "C5": true, "C6": true}}
